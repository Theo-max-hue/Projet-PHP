        ...
        <div class="col" id="div_avec_scrollFirst">
            ...
            <div class=image>
                ...
                <div class=prixAndButton>
                    ...
                    <div class=btnAjou><button class="button btn btn-warning" value="./image/missileTurque.jpg" data-id="<?php echo $user->getId() ?>">Ajouter</button></div>
                </div>
            </div>
            <div class=image>
                ...
                <div class=prixAndButton>
                    ...
                    <div class=btnAjou><button class="button btn btn-warning" value="./image/missile pakistan.jpg" data-id="<?php echo $user->getId() ?>">Ajouter</button></div>
                </div>
            </div>
            <div class=image>
                ...
                <div class=prixAndButton>
                    ...
                    <div class=btnAjou><button class="button btn btn-warning" value="./image/missile.jpg" data-id="<?php echo $user->getId() ?>">Ajouter</button></div>
                </div>
            </div>
            <div class=image>
                ...
                <div class=prixAndButton>
                    ...
                    <div class=btnAjou><button class="button btn btn-warning" value="./image/falloutEcran.png">Ajouter</button></div>
                </div>
            </div>
            <div class=image>
                <a href="#"></a> <img src="./image/falloutEcran.png" class="rounded" alt="test" width="300px"></a>
